...
class NODES_CORE_API PythonCodeGenerator {
   public:
    struct Options {
        ...
        bool use_graph_api =
            true;  // Use RuzinoGraph API (vs raw node operations)
     ...
     * @param required_node Optional: only generate code for nodes needed to
     * compute this node
 ...
 * @param required_node Optional: only generate code for this node and its
 * dependencies
